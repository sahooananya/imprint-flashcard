...
export default function DeckPage() {
  ...
  const S = {
    ...
    cardAnswer: { fontFamily: 'DM Sans', color: 'var(--text-primary)', fontSize: '1.05rem', lineHeight: 1.7, wordBreak: 'break-word', overflowWrap: 'break-word' },
    badge: { fontFamily: 'DM Mono', fontSize: 11, borderRadius: 9999, padding: '2px 10px', border: '1px solid var(--border)', background: 'var(--bg-raised)', color: 'var(--text-muted)' },
    surface: { background: 'var(--bg-card)', border: '1.5px solid var(--border)', borderRadius: 16, boxShadow: 'var(--card-shadow)' },
    btn: { fontFamily: 'DM Sans', borderRadius: 12, padding: '10px 20px', cursor: 'pointer', transition: 'all 0.15s ease', border: '1.5px solid var(--border)', background: 'var(--bg-raised)', color: 'var(--text-secondary)' },
    btnPrimary: { fontFamily: 'DM Sans', borderRadius: 12, padding: '10px 24px', cursor: 'pointer', transition: 'all 0.15s ease', border: 'none', background: 'var(--amber)', color: '#1a1612', fontWeight: 500 },
  };
